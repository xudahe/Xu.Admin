/**
 * @author xuanzai
 * @description 防抖函数（效果：用户交互行为过于频繁而被禁止调用，一段时间后释放）
 * @param {Function} callback 回调函数
 * @param {Number} time 防抖时间间隔，默认为1000ms
...
/**
 * @author xuanzai
 * @description 节流函数（效果：用户交互行为间隔触发回调，防止用户频繁点击）
 * @param {Function} callback 回调函数
 * @param {Number} wait 节流时间间隔，默认为1000ms
 * @returns {Function}
 * 示例：const callback = () => { }
