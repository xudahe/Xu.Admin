...
export default {
	...
	data() {
		return {
			...
			optionImgUrl1: require('../../../../../static/img/newhome/icon/bg_选项_sel.png'),
			optionImgUrl2: require('../../../../../static/img/newhome/icon/bg_选项_nor.png'),
			currentindex: -1,
		};
	},
	methods: {
		//列表操作
		expandlist(indx, item) {
            let _this = this;
            _this.currentindex = indx;
...
<style lang="less" scoped>
    ...
    .bgActive-ja {
        // background-image: linear-gradient(to right, #0084db, #0151a8) !important;
    ...
    .bgActiveF-ja {
        // background-image: linear-gradient(to right, #01459d, #0b4893) !important;
