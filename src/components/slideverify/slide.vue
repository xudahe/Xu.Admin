<template>
  <div id="slide" style="margin-top:10px;">
      <slide-verify ref="slideblock" @success="onSuccess" @again="onAgain" @fulfilled="onFulfilled" @fail="onFail" @refresh="onRefresh" :imgs="imgs" :accuracy="accuracy"></slide-verify>
      <div>{{msg}}</div>
      <verify></verify>
  </div>
</template>
...
<script>
    import img0 from '../../assets/img/slide/img.jpg';
